...
class _$AuthEventTearOff {
  ...
  _LoggedIn loggedIn(TokenResultElement user) {
    return _LoggedIn(
      user,
    );
  }
...
mixin _$AuthEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(TokenResultElement user) loggedIn,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(TokenResultElement user)? loggedIn,
...
abstract class _$LoggedInCopyWith<$Res> {
  ...
  $Res call({TokenResultElement user});

  $TokenResultElementCopyWith<$Res> get user;
}
    ...
    return _then(_LoggedIn(
      user == freezed
          ...
          : user // ignore: cast_nullable_to_non_nullable
              as TokenResultElement,
    ));
  }

  @override
  $TokenResultElementCopyWith<$Res> get user {
    return $TokenResultElementCopyWith<$Res>(_value.user, (value) {
...
abstract class _LoggedIn implements AuthEvent {
  const factory _LoggedIn(TokenResultElement user) = _$_LoggedIn;

  TokenResultElement get user;
  @JsonKey(ignore: true)
  _$LoggedInCopyWith<_LoggedIn> get copyWith =>
      throw _privateConstructorUsedError;
}
